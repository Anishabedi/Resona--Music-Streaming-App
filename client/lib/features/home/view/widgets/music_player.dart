...
class MusicPlayer extends ConsumerWidget{
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userFavourites = ref.watch(currentUserNotifierProvider.select((data) => data!.favourites));
    final songs = ref.watch(getAllSongsProvider).asData?.value ?? [];
                ...
                child: Column(
                  children: [
                    ...
                    StreamBuilder(
                        ...
                        stream: songNotifier.audioPlayer?.positionStream ?? const Stream.empty(),
                      builder: (context, snapshot) {
                          if(snapshot.connectionState == ConnectionState.waiting){
                            return const SizedBox();
                          }
                          final position = snapshot.data;
                          final duration = songNotifier.currentDuration;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        onTap: () => songNotifier.toggleShuffle(),
                          child: Padding(
                            ...
                            child: Image.asset(
                              ...
                              color: songNotifier.isShuffling
                                  ? Pallete.whiteColor
                        ...
                        GestureDetector(
                          onTap: () => songNotifier.playPrevious(songs),
                          child: Padding(
                            padding: const EdgeInsets.all(10.0),
                        ...
                        GestureDetector(
                          onTap: () => songNotifier.playNext(songs),
                          child: Padding(
                            padding: const EdgeInsets.all(10.0),
